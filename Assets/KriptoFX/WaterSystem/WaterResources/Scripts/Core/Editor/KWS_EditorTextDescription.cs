...
namespace KWS
{
    internal class KWS_EditorTextDescription
    {
        public static class Warnings
        {
            public static readonly string RenderingActiveOverridden = "RenderingActive state has been overridden to 'false'";
            public static readonly string SmallVolumeSize = "The wave height is greater than the water volume, which can cause rendering issues where the bottom becomes visible through the waves." 
                                                          + Environment.NewLine + "Increase the volume of water (transform.scale.y)!";

            public static readonly string PlanarReflectionUsed = "Planar reflections are very expensive and render objects twice!" + Environment.NewLine +
                                                                 "Use Planar reflections only for important objects (using planar layers mask), such as mountains/buildings or characters, and ignore minor objects (small rocks, grass, etc.)";
        ...
        {
            public static readonly string FftWavesQuality = "Higher quality refers to improved wave detailing, but it comes at the cost of reduced performance";
        ...
        public static class Reflection
        {
            ...
            public static readonly string UseReflectionProbes = "Rendering of the reflection probe is not precise, but it allows you to get almost free reflection of a simple scene. " +
                                                                "Unity supports only 2 reflection probes per mesh. "                                                                    +
                                                                "You can change the ‘reflection probe importance’ value and thus regulate which reflections will be visible at a given moment.";
        ...
        {
            public static readonly string FlowNotInitialized = @"'Flow' is activated, but the 'flowmap texture' hasn't been initialized yet. Use 'FlowMap Painter' and save the result.";
            public static readonly string FlowDescription = "A 'flow map' stores water flow directional information in a texture. " +
                                                               "When drawing with a brush, you will draw the direction of the water flow (for example, a river) to texture";

            public static readonly string FlowEditorUsage = "\"Left Mouse Click\" for painting "  + Environment.NewLine +
        ...
        public static class Mesh
        {
            ...
            public static readonly string CustomMeshUsage = "1) The pivot point should be on the surface!"                                              + Environment.NewLine +
                                                            "2) Use black/white vertex color for water masking"                                         + Environment.NewLine + Environment.NewLine +
                                                            "For example, the surface of the aquarium should be white (having waves and reflections), " +
                                                            "while the sides and bottom should be transparent (black color)."                           + Environment.NewLine;
